...
<div class="logintop">    
    ...
    <div class="loginbody" style="height: 605px">
<div class="login-container">
								...
								<div id="login-box" class="login-box widget-box no-border visible">
									<div class="widget-body">
										<div class="widget-main">
											...
											<div class="login_icon"  id="formview" action="index.php?r=login%2Fretrieve" method="post"><img src="backend/images/login.png" /></div>

											<form class=""  id="formviewd" action="index.php?r=login%2Fretrieve" method="post">
												<fieldset>
										<ul>
   <li class="frame_style form_error"><label class="user_icon"></label><input name="phone" maxlength="11" type="text"  id="phone"/><i>手机号</i></li>
   ...
   <li class="frame_style form_error"><label class="password_icon"></label><input name="userpassword" type="password"   	 id="userpwd"/><i>新密码</i></li>
   <li class="frame_style form_error"><label class="password_icon"></label><input name="userpassword2" type="password"   	 id="userpwd"/><i>确认密码</i></li>
...
function Codesregion(node){
	var _this = $(node);
 	...
 	$.ajax({
	   type: "POST",
	   url: "index.php?r=login%2Fgettrie",
	   data: {phone: phone},
