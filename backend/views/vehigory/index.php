  ...
  <div class="administrator">
    ...
    <div class="search_style">
      ...
      <ul class="search_content clearfix">
       <li><label class="l_f">车辆分类名称</label><input name="" type="text" id="goryName" class="text_add" placeholder="<?=$goryName?>" value="<?=$goryName?>"  style=" width:400px"/></li>
    ...
    <!--操作-->
     <div class="border clearfix">
       <span class="l_f">
        <a href="javascript:ovid()" id="administrator_add" class="btn btn-warning"><i class="fa fa-plus"></i> 车辆分类</a>
       </span>
     </div>
     <!--管理员列表-->
...
<div class="page">
 ...
 <div id="add_administrator_style" class="add_menber" style="display:none">
    <form action="index.php?r=vehigory/add" method="post" id="formview" enctype="multipart/form-data">
...
function  pages(page){
    ...
    window.location.href = "index.php?r=vehigory/index&page="+page+"&goryName="+goryName;

}
// 查询
$(".btn_search").on('click',function(){
    var  goryName = $("#goryName").val();
    window.location.href = "index.php?r=vehigory/index&goryName="+goryName;
})
// 编辑
function member_edit(id){
   ...
   window.location.href = "index.php?r=vehigory/edit&goryName="+goryName+"&page="+page+"&id="+id;
}
// 编辑
function member_del(id){
   ...
   window.location.href = "index.php?r=vehigory/del&goryName="+goryName+"&page="+page+"&id="+id;
}
// //初始化宽度、高度  
