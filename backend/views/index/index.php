...
function link_operating(name,title){
	...
	<body>
			...
			<div class="navbar-container" id="navbar-container">
				<div class="navbar-header pull-left">
					<a href="#" class="navbar-brand">
						<small>
						   <h1>教育系统</h1>					
						<!-- <img src="backend/images/logo.png" width="470px"> -->
						</small>
					</a><!-- /.brand -->
				</div><!-- /.navbar-header -->
		...
		<div class="main-container" style="height: 100%" id="main-container">
        <script type="text/javascript">
...
<script type="text/javascript">
					...
					<ul class="nav nav-list" id="nav_list">
                     ...
                     <li><a href="#" class="dropdown-toggle"><i class="icon-user"></i><span class="menu-text"> 用户管理 </span><b class="arrow icon-angle-down"></b></a>
					   <ul class="submenu">
                         <li class="home"><a  href="javascript:void(0)" name="index.php?r=user/index"  title="用户管理" class="iframeurl"><i class="icon-double-angle-right"></i>用户管理</a></li>
						 ...
						 <li class="home"><a href="javascript:void(0)" name="Category_Manage.html" title="分类管理"  class="iframeurl"><i class="icon-double-angle-right"></i>权限管理</a></li>

						</ul>
					</li>
					<li>
					<a href="#" class="dropdown-toggle"><i class="icon-picture "></i><span class="menu-text"> 租赁信息 </span><b class="arrow icon-angle-down"></b></a>
						<ul class="submenu">
					...
					<li>
					<a href="#" class="dropdown-toggle"><i class="icon-list"></i><span class="menu-text"> 学院作业管理 </span><b class="arrow icon-angle-down"></b></a>
                    <ul class="submenu">
           ...
           $("#menu_style").niceScroll({  
	        ...
	        cursorborderradius:"5px"  
                ...
                <script type="text/javascript">
                 ...
                 <iframe id="iframe" style="border:0; width:100%;height:100%; background-color:#FFF;"name="iframe" frameborder="0" src="index.php?r=index/main">  </iframe>
